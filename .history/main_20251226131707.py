...
def calculate_waste():
    usage_data = [
        {"resource_id": "vm-idle", "cpu": 2},
        {"resource_id": "vm-idle", "cpu": 3},
        {"resource_id": "vm-idle", "cpu": 1},
        {"resource_id": "vm-idle", "cpu": 4},

        {"resource_id": "vm-spike", "cpu": 85},
        {"resource_id": "vm-spike", "cpu": 90},
    ]  # <-- you already have this or inline data
